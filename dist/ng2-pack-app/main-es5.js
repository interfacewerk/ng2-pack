(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InlineEditableDirective = /** @class */ (function () {
                ...
                ;
                InlineEditableDirective.prototype.startEditing = function () {
                    this.originalContent = this.content;
                };
                InlineEditableDirective.prototype.keyPressed = function (event) {
                ...
                InlineEditableDirective.prototype.cancelEditing = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DefaultValuePipe = /** @class */ (function () {
                ...
                DefaultValuePipe.prototype.transform = function (value, defaultValue, args) {
                ...
                DefaultValuePipe.prototype.isEmptyString = function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TPipe = /** @class */ (function () {
                ...
                TPipe.prototype.transform = function (value, args) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR = {
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return Select2Component; }),
                multi: true
            };
            var Select2Component = /** @class */ (function () {
                ...
                Select2Component.prototype.ngOnChanges = function (arg) {
                    this.updateData();
                };
                ...
                Select2Component.prototype.writeValue = function (v) {
                    this.currentValue = v;
                    if (!this.element) {
                        return;
                    }
                ...
                Select2Component.prototype.registerOnTouched = function (fn) { this.onTouched = fn; };
                Select2Component.prototype.onClose = function (e) {
                    this.close.emit(e);
                };
                Select2Component.prototype.removeSelect2 = function () {
                    if (this.element) {
                ...
                Select2Component.prototype.updateData = function () {
                    var _this = this;
                    this.removeSelect2();
                    ...
                    this.element.on('select2:close', function (e) {
                        _this.onClose(e);
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var I18nService = /** @class */ (function () {
                ...
                I18nService.prototype.get = function (nestedKey, language) {
                    ...
                    try {
                        translation = keys
                            .reduce(function (translationTree, key) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SortableItemDirective = /** @class */ (function () {
                function SortableItemDirective(elementRef) {
                    ...
                    this.lastEvent = '';
                    this.updateElements = function (dragged, droppedOn) {
                ...
                // draggable
                SortableItemDirective.prototype.onDragStart = function (dragEvent) {
                ...
                // droppable
                SortableItemDirective.prototype.onDragEnter = function (dragEvent) {
                ...
                SortableItemDirective.prototype.onDragOver = function (dragOverEvent) {
                    // necessary for drop event to be triggered
                    dragOverEvent.preventDefault();
                };
                // droppable
                SortableItemDirective.prototype.onDragEnd = function (dragEvent) {
                ...
                // droppable
                SortableItemDirective.prototype.onDrop = function (dropEvent) {
                    this.lastEvent = 'drop';
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddColumnComponent = /** @class */ (function () {
                ...
                AddColumnComponent.prototype.ngOnChanges = function (arg) {
                ...
                AddColumnComponent.prototype.onSelected = function (value) {
                    var _this = this;
                    if (!value) {
                        return;
                    }
                ...
                AddColumnComponent.prototype.columnsNotVisibleInTable = function () {
                    var _this = this;
                    var items = [];
                    this.tableComponent.columnsConfig.forEach(function (columnConfig) {
                ...
                AddColumnComponent.prototype.categorizeColumns = function (columns) {
                    var itemsWithCategory = columns.filter(function (item) { return typeof item.category !== 'undefined'; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColumnState = /** @class */ (function () {
                ...
                ColumnState.prototype.toggleDirection = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormatColumnPipe = /** @class */ (function () {
                ...
                FormatColumnPipe.prototype.transform = function (value, column) {
                    if (!column) {
                        return;
                    }
                ...
                FormatColumnPipe.prototype.applyFormatters = function (value, formatters) {
                    if (!formatters) {
                        return value;
                    }
                    return formatters.reduce(function (currentValue, formatter) {
                        var args = formatter.arguments || [];
                        return formatter.transform.apply(formatter, [currentValue].concat(args));
                    }, value);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableInitService = /** @class */ (function () {
                ...
                TableInitService.prototype.detectColumnConfiguration = function (rows) {
                    var columnsLookup = this.detectColumnLookup(rows);
                    return [columnsLookup, this.columnsLookup2Config(columnsLookup)];
                };
                TableInitService.prototype.detectColumnLookup = function (rows) {
                    var columnsLookup = {};
                ...
                TableInitService.prototype.columnsConfig2Lookup = function (columnsConfig) {
                    var columnsLookup = {};
                    columnsConfig.forEach(function (columnConfig) {
                        var activeFields = [];
                        if (typeof columnConfig.subFields !== 'undefined') {
                            activeFields = columnConfig.subFields
                                .filter(function (subfield) { return subfield.isVisible; })
                                .map(function (subfield) { return subfield.id; });
                        }
                        var columnState = new _column_state_class__WEBPACK_IMPORTED_MODULE_1__["ColumnState"](columnConfig);
                        columnState.activeFields = activeFields;
                        columnsLookup[columnConfig.id] = columnState;
                    });
                    return columnsLookup;
                };
                TableInitService.prototype.columnsLookup2Config = function (columnsLookup) {
                    var columnsConfig = [];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableSortingService = /** @class */ (function () {
                ...
                TableSortingService.prototype.sort = function (rows, columnState) {
                    ...
                    rows.sort(function (a, b) { return cmpFn(a[columnState.config.id], b[columnState.config.id]); });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableDefaults = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["InjectionToken"]('TableDefaults');
            ...
            var TableComponent = /** @class */ (function () {
                ...
                TableComponent.prototype.ngOnChanges = function (arg) {
                ...
                TableComponent.prototype.isSorted = function (column, direction) {
                    if (!column) {
                        return;
                    }
                ...
                TableComponent.prototype.onRowClicked = function (rowClickEvent) {
                    this.rowClick.emit(rowClickEvent);
                };
                TableComponent.prototype.onSortColumn = function (sortEvent) {
                    this.sortColumn.emit(sortEvent);
                    if (this.rowsSortingMode === 'default') {
                        this.sortRows(this.rows, sortEvent);
                    }
                };
                TableComponent.prototype.onAddingColumn = function (index) {
                    this.addingColumnIndex = index;
                    // TODO: this should emit also when adding to the last column!
                    // this.addingColumn.emit(index);
                };
                TableComponent.prototype.onReorderColumns = function (reorderColumnsEvent) {
                    this.reorderColumns.emit(reorderColumnsEvent);
                };
                TableComponent.prototype.onToggleSubfield = function (toggleSubfieldEvent) {
                    this.toggleSubfield.emit(toggleSubfieldEvent);
                };
                TableComponent.prototype.sortRows = function (rows, sortEvent) {
                ...
                TableComponent.prototype.initialSort = function () {
                ...
                TableComponent.prototype.initializeDefaults = function () {
                    var _a;
                    var isWithoutData = (typeof this.rows === 'undefined' || this.rows.length === 0);
                    if (typeof this.columnsConfig === 'undefined' && !isWithoutData) {
                        _a = this.tableInitService.detectColumnConfiguration(this.rows), this.columnsLookup = _a[0], this._columnsConfig = _a[1];
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TbodyComponent = /** @class */ (function () {
                ...
                TbodyComponent.prototype.ngAfterViewInit = function () {
                    var _this = this;
                    setTimeout(function () {
                ...
                TbodyComponent.prototype.isSorted = function (column, direction) {
                    return this.tableComponent.isSorted(column, direction);
                };
                TbodyComponent.prototype.column = function (columnName) {
                    return this.columnsLookup[columnName];
                };
                TbodyComponent.prototype.onRowClicked = function (rowIndex, rowObject) {
                    this.rowClick.emit({
                        rowIndex: rowIndex,
                        rowObject: rowObject
                    });
                };
                TbodyComponent.prototype.onEditCell = function (tdComponent, rowIndex) {
                ...
                TbodyComponent.prototype.delegateInput = function (propertyName, defaultValue) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThComponent = /** @class */ (function () {
                ...
                ThComponent.prototype.isSortingDisabled = function (column) {
                    if (!column) {
                        return;
                    }
                    return this.rowsSortingMode === 'disabled' || column.config.sortingDisabled;
                };
                ThComponent.prototype.showSortIcon = function (column, sortType, direction) {
                    if (!column) {
                        return false;
                    }
                ...
                ThComponent.prototype.onSortColumn = function (column, direction) {
                    if (this.isSortingDisabled(column)) {
                        return;
                    }
                    if (!direction) {
                ...
                ThComponent.prototype.onRemoveColumn = function (columnName) {
                    var columnIndex = this.visibleColumns.indexOf(columnName);
                    this.visibleColumns = this.visibleColumns.slice(0, columnIndex).concat(this.visibleColumns.slice(columnIndex + 1));
                    this.removeColumn.emit(columnName);
                };
                ThComponent.prototype.onToggleSubfield = function (column, subfieldName) {
                ...
                ThComponent.prototype.delegateInput = function (propertyName, defaultValue) {
                    if (!this.tableComponent) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TheadComponent = /** @class */ (function () {
                ...
                TheadComponent.prototype.ngOnInit = function () {
                    if (this.reorderingEnabled) {
                        this.initializeSortable();
                    }
                };
                TheadComponent.prototype.ngAfterViewInit = function () {
                    var _this = this;
                    setTimeout(function () {
                        _this.customTemplate = _this.elementRef.nativeElement.children.length !== 1;
                    });
                ...
                TheadComponent.prototype.isSorted = function (column, direction) {
                    if (!this.tableComponent) {
                        return false;
                    }
                    return this.tableComponent.isSorted(column, direction);
                };
                TheadComponent.prototype.column = function (columnName) {
                    return this.columnsLookup[columnName];
                };
                TheadComponent.prototype.selectNewColumn = function (item, atPosition) {
                    this.addingColumnIndex = null;
                    this.lastColumnComboboxActive = false;
                    if (typeof atPosition !== 'undefined') {
                        // the order changed
                        this.visibleColumns = this.visibleColumns.slice(0, atPosition).concat([
                            item.value
                        ], this.visibleColumns.slice(atPosition));
                    }
                    else {
                        this.visibleColumns = this.visibleColumns.concat([item.value]);
                    }
                    this.addColumn.emit(item.value);
                    // this.visibleColumnsOutput.emit(this.visibleColumns);
                };
                TheadComponent.prototype.toggleCombobox = function () {
                    var _this = this;
                ...
                TheadComponent.prototype.onAddCombobox = function (index) {
                    this.lastColumnComboboxActive = false;
                    this.addingColumnIndex = index;
                    this.addingColumn.emit(index);
                };
                TheadComponent.prototype.onSortColumn = function (sortEvent) {
                    if (this.tableComponent) {
                        this.tableComponent.sortedColumnName = sortEvent.column;
                    }
                    this.sortColumn.emit(sortEvent);
                };
                TheadComponent.prototype.onToggleSubfield = function (toggleSubfieldEvent) {
                    this.toggleSubfield.emit(toggleSubfieldEvent);
                };
                TheadComponent.prototype.initializeSortable = function () {
                    var _this = this;
                ...
                TheadComponent.prototype.delegateInput = function (propertyName, defaultValue) {
                    if (!this.tableComponent) {
                        // console.warn('TheadComponent: No parent "tableComponent" was found.' +
                        //   'Input "' + propertyName + '" was also not provided.');
                        return defaultValue;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(tableExampleService) {
                ...
                Object.defineProperty(AppComponent.prototype, "rowsWithStudies", {
                    get: function () {
                ...
                AppComponent.prototype.onAction = function (action) {
                    if (this.actionList.length > 3) {
                        this.actionList.shift();
                    }
                    this.actionList.push(action);
                };
                AppComponent.prototype.isCustomField = function (columnId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var generatePeople = function (numberOfRecords) {
                var people = [];
                for (var i = 0; i < numberOfRecords; i++) {
                    var studies = [];
                    var studiesCount = rand(1, 4);
                    for (var j = 0; j < studiesCount; j++) {
                        var study = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var StudiesCellComponent = /** @class */ (function () {
                function StudiesCellComponent() {
                }
                StudiesCellComponent.prototype.isSubColumnVisible = function (subcolumn) {
                    return (this.col.activeFields.indexOf(subcolumn) !== -1);
                };
                Object.defineProperty(StudiesCellComponent.prototype, "allSubfieldsHidden", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableExampleService = /** @class */ (function () {
                function TableExampleService(datePipe) {
                ...
                return TableExampleService;
            }());
            TableExampleService.ctorParameters = function () { return [
